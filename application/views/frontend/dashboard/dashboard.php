            ...
            <a href="<?php echo base_url('creditors'); ?>">
              <div class="panel bg-pink-400">
                <div class="panel-body">
                  ...
                  <h3 class="no-margin"><?php echo isset($creditors_amount) ? $creditors_amount : '0'; ?></h3>
                  Creditors
                  <div class="text-muted text-size-small"></div>
                </div>
                <div id="server-load"></div>
        ...
        <div class="col-lg-10">
          <a href="<?php echo base_url('expenditure/').'/'.date('F-Y').'/'.clean_url($cname); ?>" target="_blank">
            <div class="progress skill-bar progress-striped active">
              <div class="progress-bar <?php echo $per_class; ?>" role="progressbar" aria-valuenow="<?php echo isset($cat->percentage) ? $cat->percentage : ''; ?>" aria-valuemin="0" aria-valuemax="100">
                <span class="skill">
