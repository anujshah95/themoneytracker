            ...
            <div class="page-header mb-5">
                <div class="page-header-content">
                    <div class="page-title pt-5 pb-5">
                        <h4><a href="<?php echo base_url(); ?>" style="color:black"><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span></a> - Add fund
                        </h4>
                    </div>
                </div>
            </div>
                            ...
                            <div class="panel panel-flat">
                                <div class="panel-body pt-5 pr-5 pb-5 pl-5">
                                    <div class="row">
                                        ...
                                        <form action="<?php echo base_url('add-fund-data'); ?>" method="POST" name="add_fund_data" id="add_fund_data">
                                            <div class="col-lg-8 col-lg-offset-2">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="form-group has-feedback">
                                                            <input type="text" class="form-control" placeholder="Enter fund amount" name="fund_amount" id="fund_amount" value="<?php echo set_value('fund_amount'); ?>" required="" autofocus >
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="form-group has-feedback">
                                                            <input type="text" class="form-control" placeholder="Enter description" name="fund_desc" id="fund_desc" value="<?php echo set_value('fund_desc'); ?>" required="" autofocus >
